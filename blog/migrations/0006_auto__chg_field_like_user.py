...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Like.user'
        db.alter_column(u'blog_like', 'user', self.gf('django.db.models.fields.IPAddressField')(default='192.168.254.254', max_length=15))
    ...
    models = {
        u'blog.like': {
            ...
            'user': ('django.db.models.fields.IPAddressField', [], {'default': "'192.168.254.254'", 'max_length': '15', 'null': 'True'})
        },
        u'blog.post': {
