...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'blog_post', 'description', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Post.description'
        db.alter_column(u'blog_post', 'description', self.gf('django.db.models.fields.CharField')(max_length=50))
